...
export default function Bookmark() {
    ...
    // const bookmark = data.bookmarkData.filter((item) => item.isBookmarked).filter((item) => item.title.toLowerCase().includes(searching.toLowerCase()))
    const bookmarkMovie = data.bookmarkData.filter((item) => item.category === 'Movie')
    const bookmarkTVSeries = data.bookmarkData.filter((item) => item.category === 'TV Series')
